export default function DiscoveryValueProp() {
  return (
    <section
      className="mb-10 py-5 px-5 sm:px-6 rounded-xl bg-accent-soft/40 border border-accent/10"
      aria-label="Diferencial de ECO"
    >
