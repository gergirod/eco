      ...
      <div className="card p-5 mb-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-[12px] text-gray-400 mt-0.5">Pipeline: {STEPS.join(" → ")}</p>
          </div>
        ...
        <p className="text-[11px] text-gray-400 mt-3 leading-relaxed">
          La ejecución real corre <strong>local</strong> (IP residencial + Modal). Este panel refleja el avance; el
          chequeo “en vivo” es real on-demand.
        </p>
      </div>
                ...
                <tr key={c.id}>
                  ...
                  <td>
                    ...
                    <div className="text-[11px] text-gray-400">
                      {c.subscribers} subs {c.handle_verified ? "" : "· handle a verificar"}
                    </div>
                  </td>
                  ...
                  <td className="text-right tabular-nums">
                    {c.stats?.avg_concurrent ? compact(c.stats.avg_concurrent) : "—"}
                  </td>
